...
To match these weather station data to each county we calculate the distance to the center of each administrative region. For those municipalities within a 200 kilometers radius we obtain daily county values for temperature using inverse distance weighting techniques.
